	...
	return (
		...
		>
			<div className="max-w-5xl mx-auto px-4">
				<h2 className="text-3xl font-extrabold mb-10 gradient-text text-center drop-shadow-lg tracking-tight animate-fade-in-up" style={{animationDelay: '0.1s', animationFillMode: 'both'}}>
					Projects
				</h2>
